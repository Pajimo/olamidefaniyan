          ...
          <div className="flex pt-10 pb-10 justify-end font-mono">
            ...
            <div className="-mr-2 flex md:hidden">
              <button
                ...
                type="button"
                className="inline-flex items-center justify-center mr-2 rounded-md text-green-500 hover:text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
